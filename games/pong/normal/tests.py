...
def train_model(layer_config, learning_rate, data_normalization):
    ...
    data = pd.read_csv('output/prepared_pong_pong_normal.csv', delimiter=',')
...
with open("output/results_normal.csv", "w") as file:
...
for layer_config in layer_configs:
    for learning_rate in learning_rates:
        for normalization_method in normalization_methods:
            ...
            with open("output/results_normal.csv", "a") as file:
